...
export default function CreateModulePage() {
  ...
  async function uploadPicture(file: File): Promise<string | null> {
    try {
      ...
      if (error) {
        ...
        alert(t("module.errorUploadingPicture"));
        return null;
      }
  ...
  function handlePictureChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (file) {
      ...
      if (!file.type.startsWith("image/")) {
        alert(t("module.selectImageFile"));
        return;
      }

      // Validate file size (max 5MB)
      if (file.size > 5 * 1024 * 1024) {
        alert(t("module.fileSizeLimit"));
        return;
      }
  ...
  async function finishModuleCreation() {
    ...
    setLoading(true);
    try {
      // Update module to published if requested
      if (isPublished) {
        await supabase
          .from("modules")
  ...
  const steps = [
    {
      number: 1,
      title: t("backoffice.moduleInformation"),
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-din-semibold text-foreground">
              {t("backoffice.createModule")}
            </h1>
            <p className="text-muted-foreground mt-2">
              {t("backoffice.createModuleDescription")}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            <h2 className="text-xl font-semibold mb-6 text-foreground">
              {t("backoffice.moduleInformation")}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder={t("module.moduleTitlePlaceholder")}
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-xl shadow-soft bg-background">
                <TiptapEditor
                  ...
                  placeholder={t("module.moduleDescriptionPlaceholder")}
                />
              </div>
            </div>

            <div className="space-y-2">
              <Label htmlFor="picture">{t("module.modulePicture")}</Label>
              <div className="space-y-4">
                  ...
                  {pictureUrl ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-gray-500">
                      ...
                      <p className="text-sm font-medium mb-1">
                        {t("module.clickToUpload")}
                      </p>
                      <p className="text-xs text-gray-400">
                        {t("module.dragAndDropSupported")}
                      </p>
                    </div>
                  )}
                </div>
                ...
                {uploadingPicture && (
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    {t("module.uploadingPicture")}
                  </div>
                )}
                <p className="text-xs text-gray-500">
                  {t("module.pictureRequirements")}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-xl shadow-soft bg-background">
                <TiptapEditor
                  content={notes}
                  onChange={setNotes}
                  placeholder={t("module.moduleNotesPlaceholder")}
                />
              </div>
            </div>
          </div>
