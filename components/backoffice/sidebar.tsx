      ...
      <div className="flex h-16 items-center px-4 border-b border-border">
        <Link href="/backoffice" className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-lg font-din-semibold text-foreground">{t('backoffice.title')}</span>
            <span className="text-xs text-muted-foreground">{t('backoffice.administration')}</span>
          </div>
        </Link>
      </div>
